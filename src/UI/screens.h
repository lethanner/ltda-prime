...
namespace Menus {
    ...
    DECLARE_MENU(Preferences, Localization::prefsmenu, 4, false, NULL);
    ...
    DECLARE_MENU(SubmixChannel, Localization::chmenu_submix, 5, false, DSP.getFlagRegisterPtr());
    ...
    DECLARE_MENU(BiAmp, Localization::biampmenu, 3, false, NULL);
};  //namespace Menus
