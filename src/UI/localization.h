...
const char btmenu_disconn[] = "Разорвать соединение";
// меню группы каналов
...
const char btmenu_disconn[] = "Disconnect";
// channel group menu
...
#define STR_DEV_INFO "LTDA Prime v0.3.6a"
...
const char *const btmenu[] = { channelmenu_title, channelmenu_mon, btmenu_disconn };