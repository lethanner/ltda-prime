...
const DRAM_ATTR uint32_t db_calibr_ledmonitor[] = {
    0, 23698, 47285, 94345, 188243, 375595,
    749411, 1495271, 2983458, 5305422, 8408526,
    13326616, 16777215
};
...
const DRAM_ATTR uint32_t db_calibr_onscreen[] = {
    0, 1333, 1678, 2112, 2659, 3347,
    4214, 5305, 6679, 8409, 10586,
    13327, 16777, 21121, 26590, 33475,
    42142, 53054, 66791, 84085, 105857,
    133266, 167772, 211213, 265901, 334749,
    421425, 530542, 667913, 840853, 1058571,
    1332662, 1677722, 2112126, 2659010, 3347495,
    4214246, 5305422, 6679130, 8408526, 10585708,
    13326616, 16777215
};