...
<ul>
    ...
    <li>Режим <a href="https://en.wikipedia.org/wiki/Bi-amping_and_tri-amping">Bi-Amping</a> для многополосной акустики
        <ol>
            <li><b>Моно Bi-Amping:</b> вывод НЧ на левый канал и ВЧ на правый (Submix без изменений)</li>
            <li><b>Стерео Bi-Amping:</b> вывод НЧ на канал Master, перенаправление ВЧ с Master на Submix (требуется внешний усилитель)</li>
        </ol>
    </li>
</ul>
